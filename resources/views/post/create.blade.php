    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mx-4 sm:p-8">
            <form method="post" action="{{route('post.store')}}" enctype="multipart/form-data">
                ...
                <!-- 追加: タグ入力欄 -->
                <div class="w-full flex flex-col">
                    <label for="tags" class="font-semibold leading-none mt-4">タグ (半角、全角スペース区切りどちらでも複数入力可能)</label>
                    <input type="text" name="tags" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="tags" value="{{old('tags')}}" placeholder="Enter Tags">
                </div>
