        ...
        <div class="mx-4 sm:p-8">
            <form method="post" action="{{route('post.update', $post)}}" enctype="multipart/form-data">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="tags" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="tags" value="{{old('tags', $post->tags->pluck('name')->implode(','))}}" placeholder="タグを,で区切って入力">
                </div>
